...
console.log(result1);
  ...
  const countryOptions1 = [
    { key: '1', value: 5,  text: '5 ostatnich emocji'},
    { key: '2', value: 10,  text: '10 ostatnich emocji'},
    { key: '3', value: 15, text: '15 ostatnich emocji'},
    { key: '4', value: 20, text: '20 ostatnich emocji'},
    { key: '5', value: 25, text: '25 ostatnich emocji'},
]
...
console.log(resultrozgniewany)
  ...
  return (
    ...
    <div style={{
            display: 'block', width: 250, padding: 30, marginLeft: 50
    }}>
                 ...
                 <Dropdown 
                    ...
                    search
                    selection
                    placeholder='Ilość ostatnich emocji'
