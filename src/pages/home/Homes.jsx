...
const Homes = ({_id,  title, desc, createdAt, ratingSlaby, ratingZaskoczony,
ratingZniesmaczony, ratingLekliwy, ratingSmutny, ratingSzczesliwy, ratingRozgniewany}) => {
...
const handleDelete = async ()=>{
  try{
    console.log(_id)
await axios.delete("https://emotioapi.onrender.com/posts/"+_id, {
...
useEffect(() => {
  const getPost = async () => {
    const res = await axios.get("https://emotioapi.onrender.com/posts/?user="+user._id);
    ...
    <Card.Content extra>
        <div >
          <Button basic color='blue'>
            ...
            <Link to={`/dodaj/${_id}`} className='btn1'>
        Reguluj emocję
      </Link>
          </Button>
