...
const [data1, setData1] = useState([]);
  ...
  const [apiUrl, setApiUrl] = useState('https://emotioapi.onrender.com/posts/?user='+user._id+'&limit=4');
...
post.reverse();
 ...
 const onChange = (e, pageInfo) => {
    ...
    setApiUrl('https://emotioapi.onrender.com/posts/?user='+user._id +'&skip='+(pageInfo.activePage.toString()-1)+'&limit=4');
  };
console.log(data1)
...
//http://localhost:5000/api/posts/?user=63de58aeedaf8df67b993be8&skip=4
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      const res = await axios.get("https://emotioapi.onrender.com/posts"+ search);
      setPost1(res.data);
      console.log(res)
    };
    fetchPosts();
