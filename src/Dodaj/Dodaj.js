...
<div className='butony'>
  ...
  {/*SŁABY WSZYSTKO*/}
      ...
      <Step name="step3">
      <div>
              <Qn1>Jak długo nieprzerwanie trwa uczucie?</Qn1>
              <Controls>
                {({ back, destinations: { step12, step13, step14} }) => (
                  <>
                  <button className="button-53" onClick={step12} role="button">Minuty-godziny</button>
                  <button className="button-53" onClick={step13} role="button">Dni-miesiące</button>
                  <button className="button-53" onClick={step14} role="button">Lata</button>
                    <Buttons>
